...
class CombinedStrategyAgent:
    """Agent that uses the combined strategy"""
    ...
    def get_action(self, state: Tuple, valid_actions: List[int]) -> int:
        """Select action using combined agent strategy"""
        ...
        player_sum, dealer_visible, _, _, _ = state
    ...
    def simulate_episode(self, env) -> Dict:
        """Simulate one episode using combined agent strategy and update Q-values"""
        episode_data = []
        total_reward = 0
    ...
    def train_q_values(self, env, num_episodes: int = 50000, log_interval: int = 5000) -> None:
        """Train Q-values by simulating episodes with combined agent strategy"""
        print(f"Training Combined Agent Strategy Q-values with {num_episodes:,} episodes...")
        ...
        print("Combined Agent Strategy Q-value training completed!")

    def evaluate(self, env, num_episodes: int = 1000) -> Dict:
        """Evaluate the combined agent strategy"""
        total_rewards = []
        total_wins = []
        total_hands_count = []
